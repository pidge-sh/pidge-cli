...
line the CLI adds is the failure one — `{"type":"handler_failed","exit":N,"reason":"exit|timeout|signal|spawn_error","ids":[…]}`
— because a failure the agent can't see becomes a false green.
