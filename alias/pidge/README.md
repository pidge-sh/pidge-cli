...
`pidge` is an alias for [**`pidge-cli`**](https://www.npmjs.com/package/pidge-cli) — the
same CLI, published under the shorter name. Installing it installs `pidge-cli` and puts
